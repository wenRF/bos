...
<div data-options="region:'center'">
	<form id="functionForm" method="post"
		action="${pageContext.request.contextPath}/functionAction_add.action">
					...
					<tr>
						...
						<td>
							<input name="parentFunction.id" class="easyui-combobox"
								data-options="valueField:'id',textField:'name',url:'${pageContext.request.contextPath}/functionAction_listAjax.action'"/>
						</td>
					</tr>
					<tr>
						<td>描述</td>
