...
<script type="text/javascript">
	$(function() {
		$("#grid").datagrid({
			...
			pagination:true,
			fit:true,
			url : '${pageContext.request.contextPath}/noticebillAction_findnoassigment.action'
		});
...
<body class="easyui-layout">
	...
	<div class="easyui-window" title="人工调度" id="diaoduWindow" closed="true"
		...
		<div region="center" style="overflow:auto;padding:5px;" border="false">
			<form id="diaoduForm" method="post" action="${pageContext.request.contextPath }/workbillAction_add.action">
				<table class="table-edit" width="80%" align="center">
					...
					<tr>
						<td>通知单编号</td>
						<td><input type="hidden" name="id" id="notisbillId" /> <span
