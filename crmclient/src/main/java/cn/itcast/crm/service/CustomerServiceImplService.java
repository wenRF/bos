 ...
 * 
 */
@WebServiceClient(name = "CustomerServiceImplService", targetNamespace = "http://service.crm.itcast.cn/", wsdlLocation = "http://localhost:8080/crm/cxf/customer?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/crm/cxf/customer?wsdl");
    ...
    public ICustomerService getCustomerServiceImplPort() {
        return super.getPort(new QName("http://service.crm.itcast.cn/", "CustomerServiceImplPort"), ICustomerService.class);
    }
    ...
    public ICustomerService getCustomerServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.crm.itcast.cn/", "CustomerServiceImplPort"), ICustomerService.class, features);
    }
